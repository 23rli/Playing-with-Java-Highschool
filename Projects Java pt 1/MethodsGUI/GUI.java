...
/**
 * Class GUI Creates a graphical user interface skeleton for running methods
 * 
 * @author Richard Li
 * @version 1.0
 */
public class GUI extends JFrame implements ActionListener, FocusListener {
    ...
    Utility util = new Utility(); // Where Utility classes are
    ...
    // Panels are set up to hold other things and can be placed within the
    // MasterPanel
    ...
    public GUI(String title) {
        ...
        submitButton.setToolTipText("Sends all values in input box to get results.");
        ...
        /*
         * !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! TO ADD NEW METHODS, PUT
         * THEIR NAMES IN taksList below:
         * !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
         */
        // create tasks selector pull-down menu
        String[] taskList = { "Select:", "Combine/Reverse Strings", "Calculate Winner", "Do weird text stuff",
                "Strong Presence", "Four fit in one", "Okay, line up", "Should answer call", "Can Move", "Full URL",
                "Sum of Powers", "Almost Primes", "Greekify", "Three Powers", "Significant Figures Calculator" }; // list
                                                                                                                  // of
                                                                                                                  // names
                                                                                                                  // of
                                                                                                                  // tasks
        ...
        instructionsPanel.setBackground(
                new Color((int) (Math.random() * 256), (int) (Math.random() * 256), (int) (Math.random() * 256)));
        ...
        report = new JTextArea("hello.  this area will be the instructions, then report", 20, // height in characters
        ...
        entry = new JTextField[6];
        // make the actual entry boxes, with default width:
        for (int i = 0; i < entry.length; i++)
            entry[i] = new JTextField("", 10); // 20 is the number of characters width
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        // SUBMIT BUTTON CLICKED:
            ...
            interactions.getAndShowResults(tasks, selectedTask, report, entry, util);
        }
        // QUIT BUTTON CLICKED:
        else if (e.getActionCommand().equals("quitButton")) {

            JOptionPane.showMessageDialog(null, "HAVE A NICE DAY", "End of Thing", JOptionPane.PLAIN_MESSAGE, null);
            System.exit(0);
            ...
            instructionsPanel.setBackground(
                    new Color((int) (Math.random() * 256), (int) (Math.random() * 256), (int) (Math.random() * 256)));
            ioPanel.setBackground(
                    new Color((int) (Math.random() * 256), (int) (Math.random() * 256), (int) (Math.random() * 256)));
        }
        // YOU COULD ALSO MAKE A "CLEAR" BUTTON. WHEN CLICKED, IT WOULD CLEAR THE REPORT
        // AND/OR ENTERED TEXT
        // LOOK EVERYWHERE THERE WAS A SUBMIT BUTTON, COPY AND PASTE TO DO THE SAME WITH
        // A CLEAR BUTTON
    }
